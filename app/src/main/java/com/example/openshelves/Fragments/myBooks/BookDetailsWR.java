...
public class BookDetailsWR extends Fragment {
    BookFB bookFB;
    String genre;
    Button btnWR;
    ImageView imgBookCover;
    TextView tvTitle, tvEditura, tvAutori, tvDescription, tvGenre, tvPages, tvTime, tvDateStarted, tvProgressScreen;
    ImageButton btnBack;
    ...
    public BookDetailsWR() {
        // Required empty public constructor
    }


    public static BookDetailsWR newInstance(String param1, String param2) {
    ...
    private void displayBookItem(String volumeId, Context context) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                tvTime.setText(time);
                tvDateStarted.setText("You marked this books as want to read on " + dateStarted);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_book_details_w_r, container, false);
        btnWR = view.findViewById(R.id.btnAddBook);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fragmentStatistici == 1) {
                    ...
                    fragmentTransaction.replace(R.id.containerDetailsWR, fragment);
    ...
    private void showOptionsDialog() {
        String[] bookshelves = {"Currently Reading", "Already Read"};
